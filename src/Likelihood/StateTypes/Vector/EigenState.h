...
#ifndef SRC_LIKELIHOOD_STATETYPES_VECTOR_EIGENSTATE_H_
...
class EigenState : public boost::additive1< EigenState ,
...
template< >
struct is_resizeable< Likelihood::StateType::Vector::EigenState >
    : is_resizeable< std::vector<double> > {}; // declare resizeability
...
#endif /* SRC_LIKELIHOOD_STATETYPES_VECTOR_EIGENSTATE_H_ */
